        ...
        while (true) {
            for (int c : changes) {
                ...
                if (map.containsKey(result)) {
                    System.out.println(result + " reached twice");
                    System.exit(0);
                } else {
                    map.put(result, 1);
                }
